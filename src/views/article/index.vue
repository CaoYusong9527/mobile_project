...
<div class="detail" v-else>
  ...
  <div class="zan">
    <van-button  @click="toggleLike" round size="small" hairline type="primary" plain icon="good-job-o">{{article.attitude === 1 ? '取消点赞' : '点赞'}}</van-button>
    &nbsp;&nbsp;&nbsp;&nbsp;
    <van-button @click="toggleDislike" round size="small" hairline type="danger" plain icon="delete">  {{ article.attitude === 0 ? '取消不喜欢' : '不喜欢'}}</van-button>
  </div>
</div>
<!-- /文章详情 -->
<!-- 评论 -->
...
import { reqFollowUser, reqUnFollowUser } from '@/api/user.js'
